...
| **US-2.3** | En tant que médecin, je veux que la session se ferme et s'efface automatiquement après la consultation. | **Must**          | Au clic sur "Terminer" ou après 30 min d'inactivité (bannière d'avertissement + bouton « Prolonger » 2 min avant — #122), le nouveau dossier est chiffré, envoyé au cloud, et la RAM du médecin est vidée (_Wipe_).        |
